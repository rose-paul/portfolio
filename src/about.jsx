   ...
   return (
     <div className="flex-wrapper">
       ...
       <section className="about">
         <h2>About Me</h2>
         <p>Skills: React, Redux, Javascript, Ruby on Rails, Mapbox, SQL, PostgresSQL, MongoDB</p>
         <article>
           I came into the tech realm as a developer following my previous work
           teaching English at tech companies in Moscow. I do fullstack web
           development using several technologies and enjoy all aspects.
         </article>
         <article>
